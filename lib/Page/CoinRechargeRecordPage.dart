...
class CoinRechargeRecordPage extends StatefulWidget{
  @override
  State<StatefulWidget> createState() {
    return _CoinRechargeRecordPage();
  }
}
class _CoinRechargeRecordPage extends State<CoinRechargeRecordPage>{
  ...
  _getList()async{
    ...
    Map<String, dynamic> result = await Request.coinOrder(page: page);
    refresh = false;
    // print(result);
