...
import '../Global.dart';
import 'CoinBalancePage.dart';
import 'CoinRechargeRecordPage.dart';

class CoinRechargePage extends StatefulWidget{
  @override
  State<StatefulWidget> createState() {
    return _CoinRechargePage();
  }
}
class _CoinRechargePage extends State<CoinRechargePage>{
          ...
          Container(
            ...
            child: Row(
              ...
              children: [
                InkWell(
                  onTap: (){
                    Navigator.push(context, SlideRightRoute(page: CoinRechargeRecordPage()));
                  },
                  child: Row(
                    children: [
                      Transform(
                ...
                InkWell(
                  onTap: (){
                    Navigator.push(context, SlideRightRoute(page: CoinBalancePage()));
                  },
                  child: Row(
                    children: [
  ...
  _payment()async{
    ...
    String? result = await Request.coinPayment(id: buttons[buttonIndex].id,toId: types[typeIndex].id);
  ...
  _getBalance()async{
    balance = await Request.coinBalance();
    refresh = false;
  }
  _getButton()async{
    if(buttons.isNotEmpty && buttons.length > buttonIndex){
      Map<String,dynamic> result = await Request.coinButton(id: buttons[buttonIndex].id);
      refresh = false;
