              ...
              Row(
                children: [
                  Container(
                    ...
                    child: Image.asset(AssetsIcon.crown,color: Colors.white,),
                  ),
        ...
        children: [
          ...
          InkWell(
            child: Column(
              ...
              crossAxisAlignment: CrossAxisAlignment.center,
              children: [
                Text(Global.getNumbersToChinese(3333),style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold,fontSize: 20),),
