...
class _MyPage extends State<MyPage> with SingleTickerProviderStateMixin {
  ...
  _getInfo()async{
    ...
    if(result['appData'] != null) appData = AppData.formJson(result['appData']);
    if(mounted) setState(() {});
  }
  _openUrl(String url){
  ...
  _buildRecords(){
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                width: 200,
                child: Text(record.title,style: TextStyle(fontWeight: FontWeight.w300,fontSize: 13),textAlign: TextAlign.left,overflow: TextOverflow.fade,),
              ),
            ],
          ),
        ),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Text('浏览记录',style: TextStyle(fontSize: 15),),
  ...
  _buildApplication(){
    List<Widget> list = [
      Text('常用功能',style: TextStyle(fontSize: 15),),
      if(appData.buyDiamond) InkWell(
          onTap: (){
            Navigator.push(
                context, SlideRightRoute(page: DiamondRechargePage())).then((value) => _init());
          },
          child: Container(
      ...
      child: Container(
        ...
        child: Row(
          ...
          children: [
            ...
            Text('$gain元',style: TextStyle(color: Colors.white.withOpacity(0.6)),),
          ],
        ),
      ),
    );
        ...
        child: Row(
          ...
          children: [
            Container(
              ...
              child: Text('荣耀LV$level',style: TextStyle(color: Color(0xff6325b8),fontWeight: FontWeight.bold,fontStyle: FontStyle.italic)),
            ),
            InkWell(
              child: Row(
                children: [
                  Text('剩余23天',style: TextStyle(fontWeight: FontWeight.w200,color: Colors.white.withOpacity(0.6)),),
      ...
      return Container(
        ...
        child: Row(
          ...
          children: [
            Container(
              margin: const EdgeInsets.only(left: 45,),
              child: Text('钻石LV$level',style: TextStyle(color: Color(0xff5844c5),fontWeight: FontWeight.bold,fontStyle: FontStyle.italic)),
            ),
            InkWell(
              child: Row(
                children: [
      ...
      return Container(
        ...
        child: Row(
          ...
          children: [
            Container(
              margin: const EdgeInsets.only(left: 45,),
              child: Text('黄金LV$level',style: TextStyle(color: Color(0xffa16c17),fontWeight: FontWeight.bold,fontStyle: FontStyle.italic)),
            ),
            InkWell(
              child: Row(
                children: [
      ...
      return Container(
        ...
        child: Row(
          ...
          children: [
            Container(
              margin: const EdgeInsets.only(left: 45,),
              child: Text('白银LV$level',style: TextStyle(color: Color(0xff45458d),fontWeight: FontWeight.bold,fontStyle: FontStyle.italic)),
            ),
            InkWell(
              child: Row(
                children: [
      ...
      return Container(
        ...
        child: Row(
          ...
          children: [
            Container(
              margin: const EdgeInsets.only(left: 45,),
              child: Text('青铜LV$level',style: TextStyle(color: Color(0xff7f3b1b),fontWeight: FontWeight.bold,fontStyle: FontStyle.italic)),
            ),
            InkWell(
              child: Row(
                children: [
      ...
      child: Row(
        ...
        children: [
          InkWell(
            child: Row(
              children: [
                Text('最低仅需25元',style: TextStyle(fontWeight: FontWeight.w200,color: Colors.white.withOpacity(0.6)),),
                Icon(Icons.chevron_right,color: Colors.white.withOpacity(0.6)),
              ],
            ),
          ),
          ...
          InkWell(
            child: Column(
              children: [
                ...
                Text('金币',style: TextStyle(fontWeight: FontWeight.w200),),
              ],
            ),
          ),
          InkWell(
            ...
            child: Column(
              children: [
                Text('$diamond',style: TextStyle(fontWeight: FontWeight.bold),),
                Text('钻石',style: TextStyle(fontWeight: FontWeight.w200),),
              ],
            ),
          ),
          InkWell(
            child: Column(
              children: [
                ...
                Text('现金',style: TextStyle(fontWeight: FontWeight.w200),),
              ],
            ),
          ),
        ],
