...
class DiamondVideo extends StatefulWidget {
  const DiamondVideo({Key? key}) : super(key: key);

  @override
  _DiamondVideo createState() =>_DiamondVideo();
}
class _DiamondVideo extends State<DiamondVideo> {
  String name = '';
  int page = 1;
  int total = 1;
  bool refresh =true;
  ...
  _getList()async{
    ...
    Map<String,dynamic> map = await Request.videoDiamond(page);
    // page--;
    // print(map);
    refresh = false;
