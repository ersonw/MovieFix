  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        ...
        ///长按
        // tooltip: "狗哥最帅",
        child: Image.asset(AssetsIcon.game),
      ),
            ...
            GestureDetector(
                child: Container(
                  ...
                  child: Column(
                    ...
                    crossAxisAlignment: CrossAxisAlignment.center,
                    children: [
                      Image.asset(_index == 0 ? AssetsIcon.indexActiveIcon : AssetsIcon.indexIcon,width: 35,),
            ...
            GestureDetector(
                child: Container(
                  ...
                  child: Column(
                    ...
                    crossAxisAlignment: CrossAxisAlignment.center,
                    children: [
                      Image.asset(_index == 1 ? AssetsIcon.videoActiveIcon : AssetsIcon.videoIcon,width: 35,),
            ...
            GestureDetector(
                child: Container(
                  ...
                  child: Column(
                    ...
                    crossAxisAlignment: CrossAxisAlignment.center,
                    children: [
                      Image.asset(_index == 3 ? AssetsIcon.likeActiveIcon : AssetsIcon.likeIcon,width: 35,),
                      Text("推荐",style: TextStyle(color: _index == 3 ?Colors.white:Colors.white.withOpacity(0.6))),
                    ],
                  ),
                ),
                onTap: (){
            ...
            GestureDetector(
                child: Container(
                  ...
                  child: Column(
                    ...
                    crossAxisAlignment: CrossAxisAlignment.center,
                    children: [
                      Image.asset(_index == 4 ? AssetsIcon.myActiveIcon : AssetsIcon.myIcon,width: 35,),
